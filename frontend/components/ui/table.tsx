...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("border-b border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-950 [&_tr]:border-b", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-slate-200 bg-slate-50 font-medium dark:border-slate-800 dark:bg-slate-950 [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
