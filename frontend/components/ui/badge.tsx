  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 dark:focus:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-green-500 text-white hover:bg-green-600 dark:hover:bg-green-600",
        warning:
          "border-transparent bg-amber-500 text-white hover:bg-amber-600 dark:hover:bg-amber-600",
      },
    },
    defaultVariants: {
      variant: "default",
